...
class varyQwenModel(QWenModel):
    ...
    def __init__(self, config: QWenConfig):
        ...
        self.vision_tower = CLIPVisionModel.from_pretrained('/home/notebook/data/personal/S9055503/clip-vit-large-patch14')
    ...
    def initialize_vision_modules(
        ...
        # 224*224
        # TODO download the clip-vit in huggingface
        image_processor = CLIPImageProcessor.from_pretrained('/home/notebook/data/personal/S9055503/clip-vit-large-patch14')
        # 1024*1024
    ...
    def forward(
        ...
        if vision_tower is not None and (input_ids.shape[1] != 1 or self.training) and images is not None:
            ...
            if len(image_features) > 1:
               image_features = [torch.cat((image_features[0],image_features[1]))]
            ...
            #print(dummy_image_features.shape)
