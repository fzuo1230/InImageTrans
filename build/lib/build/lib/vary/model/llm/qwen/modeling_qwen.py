    ...
    def forward(
        ...
        if len(need[0]) != 1:
            for it in need:
                ...
                for item in it:
                    at.append(item[280])
                with open("/home/notebook/code/personal/S9055503/Vary-main/Vary-master/explain/token_res/reco_token281.txt","a") as f:
                    f.write(str(at)+'\n')
                f.close()
        '''       
        ...
        '''
            ...
            for it in need:
                for item in it:
                    with open("/home/notebook/code/personal/S9055503/Vary-main/Vary-master/explain/token2.txt","a") as f:
                        f.write(str(item)+'\n')
                    f.close()
        '''
        #print(attn_weight.shape)
        #print(len(attn_weight.tolist()[0][0]))
        return outputs
