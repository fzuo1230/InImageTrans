...
def text_adding(img_path,new_rects,text_size,text):
    text = text.split("\n")
    ttf_path = "/home/notebook/code/personal/S9055503/DeepEraser/oppo.ttf"
    ...
    if len(new_rects) == len(text):
        ...
        for chinese in text:
            ...
            draw.text((rect[0],x),refer,font=font,fill="black")
            x = x+2*ts
    img.save("/home/notebook/code/personal/S9055503/Vary-main/Vary-master/vary/demo/output_imgs/chinese.png")
...
def draw_mask(img_path):
    ...
    img = Image.open(img_path).convert("RGB")
    img.save("/home/notebook/code/personal/S9055503/Vary-main/Vary-master/vary/demo/input_imgs/input.jpg")
    ...
    canvas.save('/home/notebook/code/personal/S9055503/Vary-main/Vary-master/vary/demo/input_imgs/output.png')
    return text_area
