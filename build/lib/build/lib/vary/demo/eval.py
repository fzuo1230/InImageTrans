...
def eval_model(args):
    ...
    #model.eval()
    #print(model)
    direct = '/home/notebook/data/personal/S9055503/benchmark/title/'
    all_images = list_images(direct)
    #print(all_images)
    '''
    ...
    #with torch.no_grad():
        ...
        #print(output_ids)
            ...
            print(generate_text)
            with open("/home/notebook/code/personal/S9055503/Vary-main/Vary-master/trans_result/baseline/output_title","a",encoding="utf-8") as f:
