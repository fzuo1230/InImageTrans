...
sys.path.append("/home/notebook/code/personal/S9055503/Vary-main/Vary-master")
from vary.train.trainer_vit_fixlr import varyTrainer
from vary.model import *
from vary.data import make_supervised_data_module,make_dpo_data_module
...
def train():
    ...
    #print(model_args)
    #model_name = os.path.expanduser(model_args.model_name_or_path)
    #print(model_name)
    ...
    #model = varyQwenForCausalLM.from_pretrained("/home/notebook/data/personal/S9055503/pretrained_model")
